...
from ..models.product_template_link import _LINK_TYPE_SELECTION
...
class ProductTemplateLinker(models.TransientModel):
    ...
    def default_get(self, fields_list):
        ...
        active_ids = ctx.get('active_ids', ctx.get('active_ids', []))
        products = []
    ...
    def action_apply_link(self):
        ...
        for product in self.product_ids:
            linked_products = product.product_template_link_ids.mapped(
